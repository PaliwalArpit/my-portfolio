				...
				<div className="row" style={{ marginTop: 7 + "rem" }}>
					<div className="col-12 col-lg-6 hidden">
						...
						<p className={"mytext pt-3 " + this.props.fadeIn}>
							...
							passionate front end developer with aspiration to 
							learn everyday and grow proffessionaly.
						</p>
						<p className={"mytext pt-3 " + this.props.fadeIn}>
							Contact number: +91 9890764723 / emaild id : arpitpaliwal14@gmail.com
						</p>
					</div>
					<div
						className={
